...
import 'package:mobile_assessment/modules/widgets/custom_error_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListenableBuilder(
        ...
        builder: (context, _) => RefreshIndicator.adaptive(
          key: _refreshIndicatorKey,
          color: Colors.white,
          backgroundColor: Colors.blue,
          strokeWidth: 4.0,
          onRefresh: () async {
            await _employeesState.fetchEmployees();
          },
          child: ErrorAndDataHandlerScreen(
            ...
            errorWidget: (value) {
              return CustomErrorWidget(errorMessage: value.first.message);
            },
            widgetBuilder: (_) {
              return Column(
                children: [
